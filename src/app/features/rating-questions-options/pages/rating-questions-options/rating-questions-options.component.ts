...
export class RatingQuestionsOptionsComponent {
  ...
  confirmSoftDelete(option: RatingQuestionOption): void {
    ...
    this.rowData = this.rowData.filter(
      (r) => r.RatingQuestionOptionId !== option.RatingQuestionOptionId
    );
    this.toastr.show('Deleted successfully', 'success');

    this.optionService
      .softDeleteRatingQuestionOption(option.RatingQuestionOptionId)
      .subscribe({
        error: () => this.toastr.show('Failed to delete on server', 'error'),
      });
  }
